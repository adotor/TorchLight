...
class TorchLight {
	static async addTorchLightButtons(app, html, data) {
		...
		function enableRelevantButtons() {
			...
			if (noCheck || (hasItemInInventory(game.settings.get("torchlight", "nameConsumableLantern")) && (hasItemInInventory("Lantern, Hooded") || hasItemInInventory("Lantern, Bullseye") || hasItemInInventory("Laterne"))))
